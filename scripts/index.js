...
$(window).scroll(function() {
    ...
    //If at the top of the page, remvoe all selected classes
    if (scroll === 0) {
        $('.menu li').removeClass('selected');
    }
...
//If on touch, toggle overlya when project is clicked
if(Modernizr.touchevents) {
    //When image is clicked on touch devic add hover class(show overlay)
...
//transistion to different parts of page 
